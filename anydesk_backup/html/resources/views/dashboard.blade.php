...
function loadAccessDeniedIncidents(page = 1) {
    ...
    const url = `/dashboard/access-denied-ajax?page=${page}`;
...
function loadUpcomingAppointments(page = 1) {
    ...
    // Fetch data via AJAX
    fetch(`/dashboard/upcoming-appointments-ajax?page=${page}`)
        .then(response => response.json())
        .then(data => {
...
function loadActiveSecurityAlerts(page = 1) {
    ...
    // Fetch data via AJAX
    fetch(`/dashboard/active-security-alerts-ajax?page=${page}`)
        .then(response => response.json())
        .then(data => {
            if (data.success) {
                const html = `
